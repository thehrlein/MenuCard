 ...
 */
class AdminOrderDelegate : AdapterDelegate<List<DisplayableItem>>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup): RecyclerView.ViewHolder {
        return AdminOrderViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.viewholder_admin_order, parent, false))
    }
